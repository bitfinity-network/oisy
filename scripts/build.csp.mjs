...
const updateCSP = (indexHtml) => {
	...
	const csp = `<meta
        ...
        connect-src 'self' https://ic0.app https://icp0.io https://icp-api.io ${ethMainnetConnectSrc} ${ethSepoliaConnectSrc} ${bitfinityConnectSrc} ${walletConnectSrc} ${onramperConnectFrameSrc};
        img-src 'self' data:;
