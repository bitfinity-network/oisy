...
export type EvmTxType = { Eip1559: null } | { Legacy: null };
export type Factor =
...
export interface _SERVICE {
	...
	query_directives: ActorMethod<[bigint, bigint], Array<[bigint, Directive]>>;
	query_pending_directive: ActorMethod<[bigint, bigint], Array<[bigint, PendingDirectiveStatus]>>;
	query_pending_ticket: ActorMethod<[bigint, bigint], Array<[string, PendingTicketStatus]>>;
